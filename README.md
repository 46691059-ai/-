...
3. `database/mysql/03_hr.sql`
4. `database/mysql/04_party.sql`
5. `database/mysql/05_project.sql`
6. `database/mysql/06_operation.sql`
7. `database/mysql/07_investment.sql`
8. `database/mysql/08_data_asset.sql`
9. `database/mysql/V1.0.0__enterprise_platform_v1.sql`
10. `database/mysql/V1.1.0__investment_data_risk_bi.sql`
